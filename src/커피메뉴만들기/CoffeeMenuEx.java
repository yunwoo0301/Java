...
public class CoffeeMenuEx {
    ...
    void selectMenu() {
        ...
        while(true) { // 버튼을 반복해서 진행하기 위해 while 문 수행
            System.out.print("메뉴를 선택하세요 : ");
            System.out.print("[1]메뉴보기, [2]메뉴조회, [3]메뉴추가, [4]메뉴삭제, [5]메뉴수정, [6]종료 : ");
            int selMenu = sc.nextInt();
            String key = ""; // 문자열 초기화
            switch (selMenu) { // 메뉴별 케이스는 스위치문 활용
                case 1 :
                    System.out.println("======= 메뉴 보기 =======");
                    for(String e : map.keySet()) { // 키만 골라서 set 객체에 담음
                    ...
                    break; // 중간에 break 를 넣지 않으면 메뉴가 연달아 구현됨
                        case 2 :
                ...
                case 6 :
                    ...
                    return; // break 사용하면 반복문(while)을 벗어날 수 없음
            }
        }
    }
}
